...
if __name__ == '__main__':
    ...
    img1 = img_process.get_merge_image('pic_bg.jpg')
    img2 = img_process.get_merge_image('pic_fullbg.jpg')
    # img1.show()
    img1.save('pic_bg_recovery.jpg')
    # img2.show()
    img2.save('pic_fullbg_recovery.jpg')
